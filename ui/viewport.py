...
class RigViewport(QWidget):
    ...
    def _setup_scene_style(self) -> None:
        try:
            self.plotter.set_background((0.96, 0.97, 0.99), top=(0.82, 0.87, 0.93))
        except Exception:
    ...
    def render_scene_full(self):
        ...
        self._configure_lights(deformed_vertices)
        ...
        self._update_ground(deformed_vertices)
        self._update_shadow(deformed_vertices)
